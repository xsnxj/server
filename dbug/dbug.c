...
/*
  ...
  DEBUG_ASSERT_AS_PRINTF
*/

#ifdef DEBUG_ASSERT_AS_PRINTF

static void default_my_debug_assert_failed(const char *assert_expr,
                                           const char *file,
                                           unsigned long line)
{
...
void (*my_debug_assert_failed)(const char *assert_expr, const char* file,
                               unsigned long line)= default_my_debug_assert_failed;
